  ...
  return (
    <main style={{color: '#FFFFFF'}}>
      <div>
        ...
        <h3 style={{margin: '5px 0'}}>Herbivore Meat</h3>
        <label>
          OQ
          <input style={{width: '75px', margin: '0 10px'}}
            type="number"
            name="herboq"
            value={ing.herboq}
        ...
        <h3 style={{margin: '5px 0'}}>Class 4 Liquid Petro Fuel</h3>
        <label>
          OQ
          <input style={{width: '75px', margin: '0 10px'}}
            type="number"
        ...
        <h3 style={{margin: '5px 0'}}>Dolovite Iron</h3>
        <label>
          OQ
          <input style={{width: '75px', margin: '0 10px'}}
            type="number"
        ...
        <h3 style={{margin: '5px 0'}}>Domesticated Oats</h3>
        <label>
          OQ
          <input style={{width: '75px', margin: '0 10px'}}
            type="number"
        ...
        <h3 style={{margin: '5px 0'}}>Tatooinian Fiberplast</h3>
        <label>
          OQ
          <input style={{width: '75px', margin: '0 10px'}}
            type="number"
        ...
        <h3 style={{margin: '5px 0'}}>Lokian Wild Wheat</h3>
        <label>
          OQ
          <input style={{width: '75px', margin: '0 10px'}}
            type="number"
        ...
        <h3 style={{margin: '5px 0'}}>Reactive Gas</h3>
        <label>
          OQ
          <input style={{width: '75px', margin: '0 10px'}}
            type="number"
        ...
        <h3 style={{margin: '5px 0'}}>Avian Meat</h3>
        <label>
          OQ
          <input style={{width: '75px', margin: '0 10px'}}
            type="number"
        ...
        <h3 style={{margin: '5px 0'}}>Advanced Solid Delivery Shell: {comp.asds.toFixed(2)}</h3>
        <h3 style={{margin: '5px 0'}}>Advanced Biological Effect Controller: {comp.abec.toFixed(2)}</h3>
        <h3 style={{margin: '5px 0'}}>
        ...
        <br />
        <h3 style={{margin: '5px 0'}}>Manual Components</h3>
        <h3 style={{margin: '5px 0'}}>
      ...
      <div>
        ...
        <h3 style={{margin: '5px 0'}}>
          ...
          <p style={{fontWeight: '100', fontSize: '0.75rem'}}>
      ...
      <div>
        ...
        <div style={{ display: "flex", flexDirection: "row", marginBottom: '50px', lignItems: 'center'}}>
          ...
          <input 
            style={{ width: "auto", height: "24px", margin: '10px 0' }}
            name="colorText"
            type="text"
            value={colorText}
